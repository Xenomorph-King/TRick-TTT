...
if CLIENT then
   ...
   SWEP.EquipMenuData = {
      type = "item_weapon",
      desc = [[Failing to remove ONE piece of DNA? 
 Want to frame someone else? This will do that!

MOUSE1 removes ALL DNA from a corpse while 
MOUSE2 changes it to ANY person.
